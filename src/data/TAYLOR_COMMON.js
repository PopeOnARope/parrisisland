export const TAYLOR_COMMON = {
  ...
  CONTENT:
    ...
    '<p>Over the course of the operation, Marines suffered 183 killed and 1487 wounded and the South Vietnamese lost 100 killed and 378 wounded. Enemy losses were reported at 1398 killed and 29 prisoner. While the operation was successful in destroying North Vietnamese food, ammunition and weapons, once the Marines were redeployed the NVA were able to return to the area. Force battalion landed near the combat base Rockpile and marched north. Catching their opponents between them, the Marine detachments forced the NVA to withdraw. For the Marines, the battle was the largest and costliest of the war to date, involving eight thousand Marines and three thousand South Vietnamese troops. The operation ended on 3 August and cost the Marines 126 killed, 448 wounded while 834 of the enemy were killed.</p>\n' +
    '<p>On the same day that Operation Hastings ended, Operation Prairie began. The purpose of the mission was to drive newly infiltrated NVA units from entrenched positions located on a ridge known as Razorback, located north of the Rockpile. From August through October, Marines, using close air support, worked through their area of operations. In the end, the Marines’ actions forced the NVA to pull back across the Ben Hai River into the northern portion of the DMZ,  but at great sacrifice; 200 Marines were killed and another 1000 injured. There were an estimated 1000 NVA casualties during the operation. In the following months and into early 1967, additional operations Prairies II-IV would continue to sweep the area while at the same time, to guard against further incursions across the DMZ, the Marines began establishing a static defense line anchored on combat bases that eventually became known as the McNamara Line.</p>',
  HOTSPOTS: [
    {
      id: 1,
      X: 600,
